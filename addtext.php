...
<?php
    ...
    if (isset($_GET['delete'])){ 
        ...
        if ($deletestmt){
            ...
            header("refresh:1; url=addtext.php");
        }
    }
?>
...
<body>
    ...
    <div class="modal fade" id="userModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel"> Add Text</h1>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-6">
                <h1>เพิ่มข่าวประเภทข้อความวิ่ง</h1>
            </div>
        ...
        <table class="table">
            ...
            <tbody>
                <?php
                $stmt = $conn->prepare("SELECT * FROM news_text");
                $stmt->execute();
                ...
                if ($result->num_rows === 0){
                    ...
                    while ($news = $result->fetch_assoc())  {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edittext.php?id=<?= $news['id']; ?>" class="btn btn-warning">Edit</a>
